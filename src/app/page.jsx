...
import { Pencil, CheckCircle, Circle, Trash2, Plus } from "lucide-react";
...
export default function TodoPage() {
  ...
  return (
    <div className="max-w-xl mx-auto mt-10 px-4">
      ...
      {!isClient ? null : filteredTasks.length === 0 ? (
        ...
        >
          ...
          >
            <ul className="custom-media space-y-2 max-h-65 mob:hidden overflow-y-auto rounded-xl overflow-x-hidden">
              <AnimatePresence>
